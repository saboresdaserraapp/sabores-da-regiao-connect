      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative py-10 sm:py-14">
          <div className="max-w-2xl text-primary-foreground">
            ...
            <p className="mt-3 text-primary-foreground/90 sm:text-lg">
              Restaurantes, pizzarias, cafés e mais — pedido pronto e enviado direto no WhatsApp do estabelecimento.
            </p>
            <div className="mt-6 flex items-center gap-2 rounded-2xl bg-card p-2 shadow-soft">
              ...
              />
              <button className="hidden sm:inline-flex items-center gap-1.5 rounded-xl bg-secondary px-4 py-2 text-sm font-medium text-secondary-foreground">
          ...
          {CATEGORIES.map(c => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex shrink-0 flex-col items-center gap-1 rounded-2xl border p-3 text-xs font-medium transition-all min-w-[90px]",
                  active
